...
"""
# A list of system instructions for the chatb
...
def RealtimeInformation():
    ...
    hour = current_date_time.strftime("%H") # Hour in 24-hour formatī
...
def ChatBot (Query):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            top_p=1, # Use nucleus sampling to control diversity. I
        ...
        with open(r"Data\Chat Log.json", "w") as f:
